    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="padding: 50px">
                ...
                <p>
                Por ejemplo, cuando usa los servicios de AutoMotor para escribir un mensaje en Gmail o un comentario en un video de YouTube, almacenamos la información que genera.
                </p>
                <p>
                Por ejemplo, cuando busca un restaurante en AutoMotor Maps o mira un video en YouTube, procesamos información sobre esa actividad, lo que incluye los siguientes datos: el video que miró, los ID del dispositivo, las direcciones IP, los datos de cookie y la ubicación.
                </p>
                <p>
                Por ejemplo, cuando busca un restaurante en AutoMotor Maps o mira un video en YouTube, procesamos información sobre esa actividad, lo que incluye los siguientes datos: el video que miró, los ID del dispositivo, las direcciones IP, los datos de cookie y la ubicación.
                </p>
