...
<body>
                        ...
                        <div class= "row">
                            <div class="col-md-9 auth-box  border-top border-dark float-left mx-auto text-light" style="margin-top:50px;margin-bottom:50px;background-color:rgba(52, 58, 64,0.8)" >
                                <div class="card-body" style="text-align:center;">
                                    ...
                                    <div class="row" style="margin: 0px 0px 30px 0px;">
                                        <div class="col-sm-6">
                                            <input value="" type="date" id="date_fechaInicio" class="form-control border border-dark">
                                        </div>
                                        <div class="col-sm-6">
                                            <input value="" type="date" id="date_fechaFin" class="form-control border border-dark">
                                        </div>
    ...
    <!-- controlador -->
    <script src="../dist/js/js_form/js_form_empleado_editar.js"></script>
